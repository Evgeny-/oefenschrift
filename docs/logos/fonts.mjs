...
// typeface review page (cut angle and share adjustable) and the ideas page from
// designs.mjs. The split O was the site's mark until September 2026; the speech-bubble
// mark that replaced it is built by mark.mjs.
//
...
console.log(`${built.length} faces, ${buildDesignsPage()} ideas`);
