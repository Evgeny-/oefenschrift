...
- Key A (Juridisch Loket). B "Nationale ombudsman": a theme-6 institution too, but for complaints about government conduct, not legal advice. C "politiebureau": the police take aangifte; they give no legal advice. (Revised after the level check: the prompt is "Waar krijgen mensen met een laag inkomen gratis advies bij een conflict over huur of werk?", 16 words, so that "juridisch" no longer appears in the prompt and only in the key; options, evidence and explanation unchanged.)
...
- Source (revised after the level check): eindterm 7.2.3 in Staatscourant 2024-15802, read on 10 September 2026 from https://repository.overheid.nl/frbr/officielepublicaties/stcrt/2024/stcrt-2024-15802/1/xml/stcrt-2024-15802.xml — "Is ervan op de hoogte dat in Nederland godsdienstvrijheid geldt", with the indicators "Weet dat iedereen vrij is om in Nederland zelf een godsdienst, levensbeschouwing of idealen te kiezen" and "weet dat de wetten van de staat boven die van religie en traditie staan" (the addition the minister made to the adviescommissie's list). The participatieverklaring (https://wetten.overheid.nl/BWBR0045555/2026-04-02#Bijlage, still the `sourceUrl`) supports the second sentence of the text, Grondwet art. 6 lid 1 ("behoudens ieders verantwoordelijkheid volgens de wet") the third. Volatility: none.
- Key A "De wet van de staat." (the second indicator, verbatim in the fact text: "De wet van de staat gaat boven de regels van een geloof of traditie."). B "De regels van het geloof.": the reversal. C "Dat kiest iedereen zelf.": true of the choice of a religion (the first indicator), not of the rank of the law; the explanation says so. The earlier question ("Wat betekent godsdienstvrijheid?") was answerable by decoding "vrijheid".
...
- Key B "Nee, dat is bij wet verboden." (revised after the level check; was "Nee, dat is verboden."). A "als het kind niet luistert": the "corrective smack" belief; the law makes no exception for disobedience. C "Nee, maar een tik mag wel." (was "Ja, maar alleen thuis."): shares the key's polarity and is the real belief that a light tik is allowed; artikel 247 lid 2 forbids all lichamelijk geweld, so the explanation now ends "Ook een tik is lichamelijk geweld en mag niet."
...
5. **meningsuiting and godsdienstvrijheid (items 12, 13).** The primary source is the participatieverklaring, a legal appendix published as an image on wetten.overheid.nl; the quotes were transcribed from that image. The Grondwet articles are cited as the second source. (Since the level check the godsdienstvrijheid item tests the 7.2.3 indicator itself, quoted from the Staatscourant XML in its source note; the participatieverklaring remains the `sourceUrl`.)
...
Applied from `content/reviews/006-007-level-check.md` (required actions 1; the optional wording, distractor and fact-text suggestions, and the seksuele-vorming and identificatieplicht polarity variants, were not applied). Key letters unchanged: A 8 / B 8 / C 8, per theme 6 A3/B3/C2, 7 A3/B2/C3, 8 A2/B3/C3.

- **juridischloket** (`prompt`): "juridisch" appeared in the prompt and only in the key. New prompt "Waar krijgen mensen met een laag inkomen gratis advies bij een conflict over huur of werk?" (16 words). Options, evidence, explanation and picture unchanged; key A.
- **godsdienstvrijheid** (`text`, `prompt`, `options`, `evidence`, `explanation`, `sourceNote`): the definitional question was answerable by decoding "vrijheid". Replaced by the level check's item on the 7.2.3 indicator "de wetten van de staat boven die van religie en traditie": third fact sentence "De wet van de staat gaat boven de regels van een geloof of traditie." (text 33 words, longest sentence 15), prompt "In Nederland geldt godsdienstvrijheid. Wat is belangrijker: de wet of de regels van een geloof?" (15 words), options "De wet van de staat." (key A) / "De regels van het geloof." / "Dat kiest iedereen zelf.", evidence "De wet van de staat gaat boven de regels van een geloof", explanation as given. The source note now opens with eindterm 7.2.3 quoted from the Staatscourant XML (the level check's paraphrase "de wetten van de staat staan boven die van religie en traditie" was replaced by the literal "weet dat de wetten van de staat boven die van religie en traditie staan"); `sourceUrl`, title, `skill` and picture unchanged.
- **geweldloos-opvoeden** (`options`, `explanation`): polarity edit, B "Nee, dat is bij wet verboden." (key), C "Ja, maar alleen thuis." → "Nee, maar een tik mag wel."; explanation ends with "Ook een tik is lichamelijk geweld en mag niet."

Media: the three revised items need new question audio. `npm run batch:check content/batches/007-original.json`: 24 items, 24 questions, keys A 8 / B 8 / C 8, no failures, no warnings. SHA-256 of the batch after this revision: `3779a18e289232c9d65ac290f7c350eee0f5c6bf8a4eca2d1db94c66ce885a4c`.
